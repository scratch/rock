...
class FormToPost_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'form-to-post'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'form-to-post'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'form-to-post'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'form-to-post'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'form-to-post');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'form-to-post'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'form-to-post');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'form-to-post'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'form-to-post') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'form-to-post');
            case 'false':
                return __('false', 'form-to-post');

            case 'Administrator':
                return __('Administrator', 'form-to-post');
            case 'Editor':
                return __('Editor', 'form-to-post');
            case 'Author':
                return __('Author', 'form-to-post');
            case 'Contributor':
                return __('Contributor', 'form-to-post');
            case 'Subscriber':
                return __('Subscriber', 'form-to-post');
            case 'Anyone':
                return __('Anyone', 'form-to-post');
        }
        return $optionValue;
    }
